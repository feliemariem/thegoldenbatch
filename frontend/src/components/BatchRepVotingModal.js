...
export default function BatchRepVotingModal() {
  ...
  return (
    ...
    <div className="batchrep-modal-overlay" style={{ zIndex: 1000 }}>
      <div className="batchrep-voting-modal" onClick={(e) => e.stopPropagation()}>
        <div className="batchrep-willingness-gate-bar"></div>
        <div className="batchrep-voting-modal-body">
